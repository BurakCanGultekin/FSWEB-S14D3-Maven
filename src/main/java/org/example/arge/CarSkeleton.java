    ...
    protected void runEngine(CarSkeleton carSkeleton){
        if (carSkeleton instanceof ElectricCar){
            ...
            System.out.println("The car engine is starting with electric. " +
                    "Per charge: " + avgKmPerCharge + ", Battery size: " + batterySize);
        } else if (carSkeleton instanceof  HybridCar){
            HybridCar hybridCar = (HybridCar) carSkeleton;
            System.out.println("The car engine is starting with hybrid. " +
                    "Per liter: " + hybridCar.getAvgKmPerLiter() +
                    ", Battery Size: " + hybridCar.getBatterySize() +
                    ", Cylinder: " + hybridCar.getCylinders());
        } else if (carSkeleton instanceof GasPoweredCar){
            GasPoweredCar gasPoweredCar = (GasPoweredCar) carSkeleton;
            System.out.println("The car engine is starting with gas power. " +
                    "Per charge: " + gasPoweredCar.getAverageKmPerLiter() +
                    ", Cylinder: " + gasPoweredCar.getCylinders());
